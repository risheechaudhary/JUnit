...
public class ToDoTests {
    ...
    public void setUp(){
        ...
        webDriverWait = new WebDriverWait(webDriver, Duration.ofSeconds(WAIT_FOR_ELEMENT_TIMEOUT));
        actions = new Actions(webDriver);
    }

    @ParameterizedTest
    @NullAndEmptySource
    void is_StringEmptyOrNull_ShouldReturnTrue(String input){
        Assertions.assertTrue(Strings.isNullOrEmpty(input));
        //Assertions.assertTrue(input == null);
    }

//    @ParameterizedTest
//    @ValueSource(ints = {1,3,5,-3,15,Integer.MAX_VALUE}) // 6 no.s
...
//    }
    ...
    public void verifyToDoListCreatedSuccessfully_withParams(String technology){
        webDriver.navigate().to("https://todomvc.com/");
    ...
    public void verifyToDoListCreatedSuccessfully_withEnum(WebTechnology technology){
        webDriver.navigate().to("https://todomvc.com/");
        openTechnologyApp(technology.getTechName());
        addNewToDoItem("Clean the house");
        addNewToDoItem("Clean the car");
        addNewToDoItem("Buy Ketchup");
        getItemCheckbox("Buy Ketchup").click();
    ...
    //EnumFilter exclusion - data driven
//    @ParameterizedTest
...
//    public void verifyToDoListCreatedSuccessfully_withParamsCSVSourceWithoutFile(String technology, String item1, String item2){
//        webDriver.navigate().to("https://todomvc.com/");
//        openTechnologyApp(technology);
//        addNewToDoItem("Clean the house");
//        addNewToDoItem("Clean the car");
...
//    }
    ...
    public void verifyToDoListCreatedSuccessfully_withArgumentsSource(String technology, List<String> itemsToAdd, List<String> itemsToCheck, int expectedLeftItems){
        webDriver.navigate().to("https://todomvc.com/");
        openTechnologyApp(technology);
    ...
    //using different classes for ArgumentSource i.e. toDoList
    @ParameterizedTest
    @ArgumentsSource(WebTechnologiesCustomArgumentsProvider.class)
    public void verifyToDoListCreatedSuccessfully_withArgumentsSourceWithSingleArgument(@AggregateWith(ToDoListAggregator.class) ToDoList toDoList){
        webDriver.navigate().to("https://todomvc.com/");
    ...
    @ParameterizedTest
    @CsvSource({"2021-11-21",
            "2022-01-12,2022"})
    public void verifyYear_whenCustomerConverter(@ConvertWith(DashDateConverter.class) LocalDate date, int expected){
